...
type Add struct {
	...
	SumRequest *SumRequest `protobuf:"bytes,1,opt,name=sum_request,json=sumRequest,proto3" json:"sum_request,omitempty"`
}
...
func (x *Add) GetSumRequest() *SumRequest {
	if x != nil {
		return x.SumRequest
	}
	return nil
...
type SumResponse struct {
	...
	NumSum int32 `protobuf:"varint,1,opt,name=num_sum,json=numSum,proto3" json:"num_sum,omitempty"`
}
...
func (x *SumResponse) GetNumSum() int32 {
	if x != nil {
		return x.NumSum
	}
	return 0
...
var file_calculator_sumpb_sum_proto_rawDesc = []byte{
	...
	,
...
var file_calculator_sumpb_sum_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_calculator_sumpb_sum_proto_depIdxs = []int32{
	0, // 0: calculator.Add.sum_request:type_name -> calculator.SumRequest
	1, // 1: calculator.SumService.Sum:input_type -> calculator.Add
...
type SumServiceClient interface {
	//Unary
	Sum(ctx context.Context, in *Add, opts ...grpc.CallOption) (*SumResponse, error)
}
...
func (c *sumServiceClient) Sum(ctx context.Context, in *Add, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
...
type SumServiceServer interface {
	//Unary
	Sum(context.Context, *Add) (*SumResponse, error)
}
...
func (*UnimplementedSumServiceServer) Sum(context.Context, *Add) (*SumResponse, error) {
...
func _SumService_Sum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SumServiceServer).Sum(ctx, req.(*Add))
	}
